...
texinfo_documents = [
  ('index', 'document', u'document',
   u'nanaka', 'document', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_author = u'document'
epub_publisher = u'document'
epub_copyright = u'copyright'
